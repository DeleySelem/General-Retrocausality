...
> **Note:** The coupling term $\lambda_0\sqrt{\frac{N_AN_B}{N_{\text{ref}}^2}}\;\hat{O}\otimes\Pi_{\mathcal{I}}$ is *bilocal in time* – it correlates the past record with the future intention, enabling retrocausal influence.
